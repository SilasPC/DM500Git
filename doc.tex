...
% Figures, pictures and tikz.
% Install Inkscape and run pdfLaTeX with ``-shell-escape'' option (for svg package).
\usepackage{svg} 
\usepackage{graphicx}
\usepackage{tikz}
...
% A way to deal with this is to use listings instead since this is based on TeX.
\usepackage{minted}
...
%%%%%%%%%%%% ACTUAL CONTENT %%%%%%%%%%%% ACTUAL CONTENT %%%%%%%%%%%%%%% ACTUAL CONTENT %%%%%%%%%%%%
% Titlepage used for clearing page headings and setting page counter to one. This also includes a \newpage when block is closed.
\begin{document}
\begin{titlepage} 
\begin{centering}
